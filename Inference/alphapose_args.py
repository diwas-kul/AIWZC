...
parser.add_argument('--nClasses', default=26, type=int,
...
parser.add_argument('--indir', dest='inputpath',
                    help='image-directory', default="./motionbert/results_test_pose/demo/")
parser.add_argument('--list', dest='inputlist',
                    help='image-list', default="")
parser.add_argument('--mode', dest='mode',
                    help='detection mode, fast/normal/accurate', default="normal")
parser.add_argument('--outdir', dest='outputpath',
                    help='output-directory', default="./motionbert/results_test_pose/demo/")
...
parser.add_argument('--posebatch', type=int, default=4,
